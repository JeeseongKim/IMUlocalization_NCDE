...
def M9_train_pose_CDE_P(**kwargs):
    ...
    #cde_model = cde_common.make_model(name='ncde', input_channels=5, output_channels=2, hidden_channels=64, hidden_hidden_channels=64, num_hidden_layers=3, use_intensity=False, initial=True)
    #cde_model = MyCDE.model_cde(input_channels=6, hidden_channels=128, output_channels=2, interpolation="cubic", **kwargs).cuda()
    cde_model = MyCDE.model_cde_P(input_channels=6, hidden_channels=128, output_channels=2, interpolation="cubic", **kwargs).cuda()
    ...
    MYdataset = my_dataset_gyroz_M9(window_size=window)
    ...
    MYValdataset = my_dataset_gyroz_M9_test(window_size=window, imu_filename=imu_file, vicon_filename=vicon_file)
    ...
    for epoch in tqdm(range(start_epoch, num_epochs, 1)):
        ...
        }, "/home/jsk/IMUlocalization/ckpt/210911_CDE_P.pth")
